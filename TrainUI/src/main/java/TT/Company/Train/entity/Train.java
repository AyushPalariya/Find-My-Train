package TT.Company.Train.entity;
...
public class Train {
    ...
    @OneToMany(mappedBy = "train", cascade = CascadeType.ALL)//fetch means jab jarurat hogi tabhi list fetch hogi
    @JsonBackReference//not save in db and not get in postman
